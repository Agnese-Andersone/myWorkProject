package mywork.configuration;

import mywork.entities.Project;
import mywork.entities.Status;
...
public class DbSessionHolder {
    ...
    private static final List<Class> ENTITIES = asList(Project.class, Task.class, Status.class);

    private static final String DB_USERNAME = "root";
    private static final String DB_PASSWORD = "21Parole";

    private static final String DB_NAME = "mywork";
